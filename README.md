...
![营销赛道一片空白](<.gitbook/assets/chan-pin-sai-dao-vs-ying-xiao-sai-dao-zhong- (1).png>)
...
3. _**\[高频次] **_人人均可发起心愿，心愿各不相同，产生高频应用；
4. _**\[二次营销] **_高参与度能形成二次营销，逐步垄断加密行业的营销市场；
...
![当前热门话题生成心愿单](.gitbook/assets/wish\_example.png)

## 三、超强的盈利模式

与狗狗币、Shib等基于社区纯共识驱动的项目不同，ZGoat是基于**营销--获利--再营销**的小闭环商业模型理念而推出的营销赛道创新型龙头产品，具有超强的盈利模式。根据市场经济学，对于共识经济产品，营销话题不足往往导致利润加速下滑，甚至入不敷出。

### 1.基础盈利能力是Shib的315倍

![小闭环商业模式](.gitbook/assets/xiao-bi-huan-.png)
...
以某知名DEX的数据为例，对比ZGoat的核心盈利场景如下所示，假设ZGoat的有效场景率是该DEX项目的20%。
...
> 3. 以前加密货币业往往只能靠代币价格上涨，或者合约做空做多赚钱，ZGoat的邀请返佣机制将开创了一种全新的盈利模式。

![](.gitbook/assets/jia-mi-hang-ye-xin-de-ying-li-mo-shi-1.png)
...
谁将是付费邀请、去中心化合约的返佣机制的最强者，我们拭目以待。用户可以通过官网的 [立即邀请](https://zgoat.org/#/Invite) 按钮来查询某地址是否已有推荐者及返佣总奖励。

{% content-ref url="dai-bi/yao-qing-fan-yong-gui-ze.md" %}
[yao-qing-fan-yong-gui-ze.md](dai-bi/yao-qing-fan-yong-gui-ze.md)
{% endcontent-ref %}

#### &#x20;<a href="oyzwl" id="oyzwl"></a>
