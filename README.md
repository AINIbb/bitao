...
{% hint style="info" %}
根据邀请返佣规则，地址A若是第一个向地址B捐赠大于等于1000w个ZGoat，则地址A永久成为地址B的推荐者。则以后地址B的每一笔交易，都将有1.2%或者0.6%de 手续费归地址A所有。以当前的币价，1000w个ZGoat的大约成本为1美金，若地址B是一个大户，30天的交易额为1000w美金，则地址A可获得的手续费返佣为12w美金或者6w美金，**相当于月投资回报可达到12万倍**。同时，地址A可以向多个用户进行邀请捐赠，若邀请的用户均产生可观的交易，则地址A的投资回报将会是一笔很大的数字收入。
