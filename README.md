...
{% tab title="Telegram" %}
[点击此链接](http://zgoat.org/sharelink)，填入地址后获得分享专属链接地址。复制文案转发至电报群或者微信群，分享链接点击量超过500可获得100w个ZGoat奖励，限前500名；获赞超过5000个可获得1000w个ZGoat奖励，限前100名。先到先得
{% endtab %}

{% tab title="Wechat" %}
[点击此链接](http://zgoat.org/sharelinktest)，获得专属分享链接及文案，转发至微信朋友圈，获赞超过30个可获得100w个ZGoat奖励，限前500名；获赞超过300个可获得1000w个ZGoat奖励，限前100名。先到先得
{% endtab %}
{% endtabs %}
